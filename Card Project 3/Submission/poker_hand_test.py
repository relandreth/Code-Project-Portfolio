"""
This module tests the poker_hand module, specifically the __compare_to function.
...
def make_test_hand( lst ):
    ...
    my_deck = dck.Deck()
    my_hand = poker.PokerHand(my_deck)
    for x in lst:
...
def main():
    # I Borrowed circumstances only from your testing from Project two, and gave
    #  you credit at the top of the module. These tests test enough of the mechanisms
    #  that they didnt cover every circumstance, but if they succeed the rest will.
