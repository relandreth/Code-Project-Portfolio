"""
This module draws a hand, compares hand values, and also lays
two hands down in an easily visual format.
...
import class_card as c
import class_deck as d
...
class PokerHand:
    ...
    def __str__(self):
        ...
        self.print_hand += str.join(self.print_hand, [self.hand[x].__str__() for x in range(self.current_hand_length())])
    ...
    def add_card(self, card=c.Card(0, 0)):
